...
\lstdefinelanguage{docker-compose-2}{
  keywords={version, volumes, services, networks, driver},
  keywordstyle=\color{blue}\bfseries,
  keywords=[2]{image, environment, ports, container_name, ports, links, build, depends_on, restart, env_file, command, bridge, "unless-stopped", never, always, configs, secrets, file, source, target, deploy, mode, replicas},
...
\lstdefinelanguage{kubernetes-yaml}{
  keywords={apiVersion, kind, metadata, spec},
  keywordstyle=\color{blue}\bfseries,
  keywords=[2]{image, name, selector, matchLabels, run, replicas, template, metadata, labels, containers, containerPort, protocol, Deployment},
  keywordstyle=[2]\color{olive}\bfseries,
  identifierstyle=\color{black},
  sensitive=false,
  comment=[l]{\#},
